    ...
    it('multiple iterations properly if {test: true} is set',
        async () => {
            ...
            const iterations = [
                ...
                {price: '0.9', toSpend: '1', profit: '0', isBought: true},
                ...
                {price: '1', toSpend: '1.09', profit: '0.1', isBought: false},
                ...
                {price: '0.9', toSpend: '1.09', profit: '0.1', isBought: true},
                // Price is high enough again. Must sell.
                {price: '1.1', toSpend: '1.1881', profit: '0.209', isBought: false},
            ]
            ...
            await waterfall(
                iterations.map((i, index) => {
                    ...
                    // Destroy previous prices and logs because 'createdAt' is
                        ...
                        console.log('prices.count', await Prices.count({where: {symbol}}));
                        // await Balances.create({asset, free: '3.0'})
                        // console.log('task: ', task);
                        // console.log('await task.reload(): ', await task.reload());
                        await simpleIteration(await task.reload())
                        const updatedTask = await task.reload().then(i => i.dataValues)
                        // console.log('updatedTask.toSpend: ', updatedTask.toSpend);
